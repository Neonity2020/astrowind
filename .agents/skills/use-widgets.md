...
| -------------- | ------------------------------------------------ | ---------------------------------------------------------- | -------------------------------------------- |
| `Hero`         | Centred hero, image below the text               | `actions`, `image`, `badge`, `content` slot                | `/`, `/about`                                |
...
| `SocialProof`  | Strip of trust signals (ratings, counts, badges) | `items[{ value, label, icon \| image, rating?, href? }]`   | `/homes/mobile-app`, `/landing/subscription` |
...
| `Content`      | Text + image split with a list of items            | `items`, `image`, `isReversed`, `isAfterContent`, `callToAction`, `content` slot                                          | everywhere                             |
